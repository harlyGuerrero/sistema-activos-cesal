  ...
  return (
    <div className="space-y-8">
      <section className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-950 dark:text-slate-300">
            Gestión de Activos
          </h1>
        ...
        <div className="flex items-center gap-3">
          <Button variant="secondary" className="bg-white shadow py-4 px-4 dark:bg-slate-700">
